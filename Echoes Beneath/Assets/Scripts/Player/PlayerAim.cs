...
// Ограничение ближней дистанции (всегда clamp'им)
...
// FirePoint всегда обновляется с нормальной дистанцией
lastValidPosition = GetClosestFirePointPosition(clampedMousePos);

// Финальная позиция, которая используется для поворота, UI и пр.
